...
Application should be run in command line (No GUI) and should take one arguments.  This argument should take cipher text as input. 

So you should run application like that:
...
S->88 , O->80, G->67, F->51, D->42, L->39 (So on.....)
...
Cipher Text Char:Plain Text Char

After input given according to given input all cipher text chars should be replaced by given rule. So 
